...
<head>
    ...
    <title>{{ $title ?? 'Autentikasi' }} | {{ config('app.name', 'Sistem Kas Sederhana Multi-User') }}</title>
...
<body x-data="{ loaded: true }" class="bg-gray-50 dark:bg-gray-900 min-h-screen flex flex-col justify-center">
    ...
    <!-- Dark/Light Mode Switcher Float -->
    <div class="fixed right-6 bottom-6 z-50">
        <button
            class="bg-brand-500 hover:bg-brand-600 inline-flex size-12 items-center justify-center rounded-full text-white shadow-lg transition-colors cursor-pointer"
